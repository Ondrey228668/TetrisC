...
int main()
{
	...
	RenderWindow window(VideoMode(320, 480), "Stupid Tetris");

	// Создание и загрузка текстуры
	Texture texture, texture_background, texture_frame;
	texture.loadFromFile("C:\\Users\\andre\\source\\repos\\test3\\images\\tiles.png");
	texture_background.loadFromFile("C:\\Users\\andre\\source\\repos\\test3\\images\\background.jpg");
	texture_frame.loadFromFile("C:\\Users\\andre\\source\\repos\\test3\\images\\frame.png");
